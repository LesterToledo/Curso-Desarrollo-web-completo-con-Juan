...
//Metodos para los Array o Arreglos

numeros = [10, 20, 30, 40, 50];

//para adicionar elementos al final de un arreglo se utiliza push pero modifica 
//el arreglo original y no es buena practica.

numeros.push(60, 70, 80);

//Para adicionar elementos al inicio del arreglo se utiliza unshift
...
//Existe la variante de eliminar desde el centro del arreglo la canidad que desee
meses.splice(2,2); //El primer numero dice cual seria el primer elemento y el segundo numero
                   // se refiere a la cantidad de elementos a borrar.
console.log(meses);
console.table(meses);

//Las buenas practicas dicen no modificar el arreglo original
// para eso utilizamos el 

//Rest operator y Spread operator
// const nuevoArregloMeses = [ ...meses, "junio"]; //Este seria el equivalente a push
const nuevoArregloMeses = [ "junio", ...meses, ]; //Este seria el equivalente a unshift
